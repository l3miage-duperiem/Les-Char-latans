...
- survivabilité : cela prend en compte la protection passive (blindage, DAL (Détecteur d'Alerte Laser) et système de fumigène automatique, silhouette, agencement des munitions, mobilité, systèmes de lutte anti-incendie automatique) et active (système de protection active, blindage réactif explosif, brouilleurs d'ondes, ...)
...
- **abandoned** : montre des signes d'abandons, souvent en combinaison avec des dégâts. L'équipement abandonné dans une zone sûre controlée par seulement l'un des deux camps ne figure pas dans ce jeu de donnés.
...
*NB: L'échelle de pertes entre les 2 graphes n'est pas la même étant donné les proportions de pertes environ 3 fois supérieures dans le camp russe comparé aux ukrainiennes. Le but de ce graphe est de mettre en avant les tendances de ces pertes.*
...
Graphiques des totaux de pertes par catégorie d'âge et de la distribution des types de pertes visuellement confirmées en fonction de la génération
...
Une hypothèse que nous pouvons raisonnablement proposer est que le niveau de modernité des MBT a une influence sur les pertes.
